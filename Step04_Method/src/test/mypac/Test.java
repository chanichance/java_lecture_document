...
public class Test {
	...
	/*
	 * String => 이 메소드를 호출한 그 위치로 String type 값을 되돌려주는 메소드
	 */
	...
	public void send(int num ) {
		System.out.println(" 을 전송해요");
	}
	public void send(String name) {
		System.out.println(" 을 전송해요");
	}
	public void send(AirPlane name) {
